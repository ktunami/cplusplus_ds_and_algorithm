...
TEST(BinaryTree, CreateFromArray) {
  ...
  auto biTree{BinaryTree::CreateFromArray<BTNode>(input)};
  std::vector<int> pre_order_traversal;
  BinaryTree::Traversal<BTNode>(biTree, pre_order_traversal, BinaryTree::TraversalType::PRE_ORDER);
...
TEST(BinaryTree, creat_frm_preorder_inorder) {
  ...
  BinaryTree::Traversal<BTNode>(tr, pre_order_traversal, BinaryTree::TraversalType::PRE_ORDER);
  BinaryTree::Traversal<BTNode>(tr, in_order_traversal, BinaryTree::TraversalType::IN_ORDER);
...
TEST(BinaryTree, sumNumbers) {
  ...
  auto biTree1{BinaryTree::CreateFromArray<BTNode>(input)};
  auto biTree2{BinaryTree::CreateFromArray<BTNode>(input)};
...
TEST(BinaryTree, pathSum) {
  ...
  auto biTr{BinaryTree::CreateFromArray<BTNode>(input)};
...
TEST(BinaryTree,isContains) {
  ...
  auto biTr1{BinaryTree::CreateFromArray<BTNode>(input1)};
  auto biTr2{BinaryTree::CreateFromArray<BTNode>(input2)};

...
#ifndef C_PRACTICE_THREAD_BINARY_TREE_H
#define C_PRACTICE_THREAD_BINARY_TREE_H
...
struct TBTNode {
  ...
  TBTNode * left;
  TBTNode * right;
  TBTNode(int x) : val{x}, ltag{0}, rtag{0},
...
#endif//C_PRACTICE_THREAD_BINARY_TREE_H

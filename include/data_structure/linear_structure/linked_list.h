...
public:
  ...
  ///@brief Reverse Nodes in k-Group (by using stack) (Nowcoder 50)
  ///@param head : Root of linked list
  ///@param k : k-Group
  ///@return Reversed group
  ListNode *reverseKGroup(ListNode *head, int k);

  ///@brief Reverse Nodes in k-Group (In place method) (Nowcoder 50)
  ///@param head : Root of linked list
  ///@param k : k-Group
  ///@return Reversed group
  ListNode *reverseKGroupInplace(ListNode *head, int k);

  ///@brief Delete duplicate elements in the linked list (Nowcoder 24)
  ///@param head : Root of linked list
  ///@return Linked list after processed
  ListNode *deleteDuplicates(ListNode *head);

  ///@brief Remove the Nth element from the end (Nowcoder 53)
  ///@param head : Root of the lined list
  ///@param n : the nth element from the end
  ///@return The processed linked list
  ListNode *removeNthFromEnd(ListNode *head, int n);

  ///@brief Group all odd nodes together followed by the even nodes (Nowcoder 133)
  ///@param head : Root of linked list
